...
def semantic(init_weights=None, gpu_ids=0, output_stride=0):
    if output_stride>0:
        model = deeplab3.Deeplabv3p(num_classes=7, output_stride=output_stride)
    else:    
        model = deeplab.Deeplab(num_classes=7)
