...
class TrainOptions():
    def initialize(self):
        ...
        parser.add_argument("--lbl_list", type=str, default='/path/to/dataset/source', help="Path to the directory containing the source label list.")
        ...
        parser.add_argument("--label_list_target", type=str, default='/path/to/dataset/target', help="Path to the directory containing the target dataset label list.")
        ...
        parser.add_argument("--num-classes", type=int, default=7, help="Number of classes for cityscapes.")
        ...
        parser.add_argument('--output_stride', type=int, default=16, help='output stride 16 or 8')
